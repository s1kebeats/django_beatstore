...
class Beat(models.Model):
    ...
    wrap = models.ImageField(upload_to='media/wraps/', default='media/wraps/S.svg')
    wave = models.FileField(upload_to='media/audio/wave/', default='')
    mp3 = models.FileField(upload_to='media/audio/mp3/', default='')
    def __str__(self):
        return self.name
